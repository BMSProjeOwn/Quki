...
{
    public class CampaignModel:DtoBase
    {
    ...
    public class CampaignUpdateModel
    {
        ...
        public List<CampaignPropertiesDefModel> CampaignPropertiesDefModel { get; set; }

        public List<CampaignDefWithCouponModel> CampaignDefWithCouponModel { get; set; }

        public List<MemberShipTypeCampaignModel> MemberShipTypeCampaignModel { get; set; }
    }
