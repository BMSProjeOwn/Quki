...
{
    public class MemberShipTypeWithCustomer:EntityBase
    {
        [Key]
        ...
        public List<MemberShipTypeWithCustomersPaymentChanel> MemberShipTypeWithCustomersPaymentChanel { get; set; }
