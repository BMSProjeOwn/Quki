...
(function($) {
    ...
    //var data = $("#VisiterCommentForm").serialize();
    //contactForm.validate({
    //    debug: false,
    //    submitHandler: function (data) {
    //        $(contactResult, data).html('Please Wait...');
    //        $.ajax({
    //            type: "POST",
    ...
    //                $(contactResult, data).html('<div class="alert alert-success" role="alert"><strong>Thank you. We will contact you shortly.</strong></div>').delay(3000).fadeOut(2000);
    //            },
    //            error: $('.thanks').show()
    //        });
    //        return false;
