...
{
    public class PaymentChanelWithDeviceTypeRepository : GenericRepository<PaymentChanelWithDeviceType>,IPaymentChanelWithDeviceTypeRepository
    {
        public PaymentChanelWithDeviceTypeRepository(DbContext context) : base(context)
        {
        }
