...
{
    public class SluDefWithLanguageRepository : GenericRepository<SluDefWithLanguage>, ISluDefWithLanguageRepository
	{
        public SluDefWithLanguageRepository(ProjeDBZuposDBContext context) : base(context)
        {
