...
{
    public class FrequentlyAskedQuestionsRepository : GenericRepository<FrequentlyAskedQuestions>, IFrequentlyAskedQuestionsRepository
    {
        public FrequentlyAskedQuestionsRepository(DbContext context) : base(context)
        {
        ...
        //    FrequentlyAskedQuestionsRepository frequentlyAskedQuestionsRepository = new FrequentlyAskedQuestionsRepository(context);
        //    var entity = frequentlyAskedQuestionsRepository.TgetItemByID(model.FrequentlyAskedQuestionsSeqID);
        ...
        //    frequentlyAskedQuestionsRepository.TUpdate(entity);
        //}
        ...
        //    var x = dbset.Where(x => x.FrequentlyAskedQuestionsSeqID == id).FirstOrDefault();
