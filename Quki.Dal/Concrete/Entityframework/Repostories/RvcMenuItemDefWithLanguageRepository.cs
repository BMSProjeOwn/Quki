...
{
    public class RvcMenuItemDefWithLanguageRepository : GenericRepository<RvcMenuItemDefWithLanguage>, IRvcMenuItemDefWithLanguageRepository
	{
        public RvcMenuItemDefWithLanguageRepository(ProjeDBZuposDBContext context) : base(context)
        {
