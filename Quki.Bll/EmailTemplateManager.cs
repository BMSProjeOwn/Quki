...
namespace Quki.Bll
{
    public class EmailTemplateManager : BllBase<NotificationTemplatess, EmailTemplateAddModel>, IEmailTemplateService
    {
        public readonly IEmailTemplateRepository repo;
        public EmailTemplateManager(IServiceProvider service) : base(service)
        {
            repo = service.GetService<IEmailTemplateRepository>();
        }
        ...
        {
            return TgetItemByID(TypeId); ;
        }
        public List<NotificationTemplatess> GetTemplateList()
        {
            return TGetList(a => a.İsActive == true).ToList().OrderByDescending(u => u.NotificationTemplatesSeqID).ToList();
        }
        ...
        {
            return TGetList(a => a.İsActive == true && a.NotificationlTypeID == TypeID).ToList().OrderByDescending(u => u.NotificationTemplatesSeqID).ToList();
        }
