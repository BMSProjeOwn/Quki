...
#if NET_2_0 || NET_STANDARD_2_0
		/// <summary>
		/// The connectionStrings key from App.Config that contains the connection string.
		/// </summary>
		/// <remarks>
		/// This property requires at least .NET 2.0. or .NET Core 2.2
		/// </remarks>
...
#if NET_STANDARD_2_0
		/// <summary>
		/// Configuration file containing connectionStrings
		/// <remarks>
		/// This property requires at least .NET Core 2.2
		/// </remarks>
		/// </summary>
		...
		virtual protected string ResolveConnectionString(out string connectionStringContext)
		{
			...
			if (!string.IsNullOrWhiteSpace(ConnectionStringFile))
			{
				...
				if (configFile.Exists)
				{
					...
					{
						configurationBuilder.AddJsonFile(configFile.FullName, optional: false);
					}
					else
					{
...
#if NET_2_0 || NET_STANDARD_2_0
		/// <summary>
		/// The connectionStrings key from App.Config/appsettings.json that contains the connection string.
		/// </summary>
